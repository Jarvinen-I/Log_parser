...
col = ['date', 'time', 'coin', 'stratname', 'price(ask)', 'depth (%)', 'rollback (R )(%)', 'delta (d)', 'dBTC (%)',
       ...
       'DumpHDelta (%)', 'Min(5min, 1sec)', 'Max(5min, 1sec)', 'Min(15min, 1sec)', 'Max(15min, 1sec)',
       'Min(30min, 1sec)', 'Max(30min, 1sec)', 'Min(60min, 1sec)', 'Max(60min, 1sec)', 'Min(1hours, 1sec)',
       'Max(1hours, 1sec)',   'Min(2hours, 1sec) = 0.53', 'Max(2hours, 1sec)', 'Min(3hours, 1sec)',
       'Max(3hours, 1sec)', 'Min(4hours, 1sec)', 'Max(4hours, 1sec)', 'Min(6hours, 1sec)', 'Max(6hours, 1sec)',
       'Min(12hours, 1sec)', 'Max(12hours, 1sec)', 'Min(24hours, 1sec)', 'Max(24hours, 1sec)']

template_signal = [('Signal', 'coin'), ('Ask', 'price(ask)'), ('dBTC', 'dBTC (%)'), ('dBTC5m', 'dBTC5m (%)'), ('dBTC1m', 'dBTC1m (%)'),
                   ('24hBTC', '24hBTC1m (%)'), ('72hBTC', '72hBTC1m (%)'), ('dMarkets', 'dMarkets: (%)'),
                   ('dMarkets24', 'dMarkets24 (%)'), ('(strategy', 'stratname'), ('Depth', 'depth (%)'),
                   ('R', 'rollback (R )(%)'), ('d', 'delta (d)')]
...
new_data.iloc[:, 4:] = new_data.iloc[:, 4:].astype('float64') # изменение строкового типа данных на числовой
